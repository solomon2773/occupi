...
/*
       ...
       // if ($this->rbacManager->isGranted(null, 'profile.own.view')) {
            ...
            $OccupiDropdownItems[] = [
                ...
                'link' => $url('occupi/showcurrentoccupancy')
            ];
            $OccupiDropdownItems[] = [
                'id' => 'showoccupancygraph',
                'label' => 'Show Occupancy Graph',
                'link' => $url('occupi/showoccupancygraph')
            ];
       // }

        if (count($OccupiDropdownItems)!=0) {
            $items[] = [
                'id' => 'occupi',
                'label' => 'OccuPi',
                'dropdown' => $OccupiDropdownItems
            ];
        }
            ...
            $items[] = [
                ...
                'dropdown' => [
                    [
                        'id' => 'settings',
                        'label' => 'Settings',
                        'link' => $url('users', ['action'=>'settings'])
                    ],
                    [
                        'id' => 'logout',
                        'label' => 'Sign out',

 ...
 */
class UserFacebookController extends AbstractActionController
{
    /**
     * Entity manager.
    ...
    public function settingsAction(){
        ...
        $facebook_user = $this->entityManager->getRepository(UserFacebook::class)->findby('core_user_id',$id);

        $facebook_user_permission = $this->entityManager->getRepository(UserFacebookPermissions::class)->findby('fb_userID',$facebook_user->getfb_userID());
        ////////get social channels permission

        return new ViewModel([
            'current_user' => $user->getUserData(),
            'facebook_user_permission' => $facebook_user_permission->getpermission()
        ]);
    }
}
